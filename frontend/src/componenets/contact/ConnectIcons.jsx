...
function ConnectIcons() {
  return (
    ...
    <div className="flex flex-col p-4">
            {/* <!-- Instagram --> */}
            <div className="flex">
            <a href="https://instagram.com/a.kumar0_" className="socialContainer containerOne m-4" target="_blank">
            ...
            {/* <!-- GitHub --> */}
            <a href="https://github.com/anshu-kumar27" className="socialContainer containerTwo m-4" target="_blank">
            ...
            {/* <!-- LinkedIn --> */}
            <div className="flex">
            <a href="https://www.linkedin.com/in/anshu-kumar-63259521b" className="socialContainer containerThree m-4" target="_blank">
            ...
            {/* <!-- Email --> */}
            <a href="mailto:anshukumar3552@gmail.com" className="socialContainer containerFour m-4">
